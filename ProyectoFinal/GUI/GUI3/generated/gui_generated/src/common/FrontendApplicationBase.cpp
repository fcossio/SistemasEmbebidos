...
#include <gui/main_1_screen/Main_1View.hpp>
...
void FrontendApplicationBase::gotoMain_1ScreenNoTransition()
{
    transitionCallback = touchgfx::Callback<FrontendApplicationBase>(this, &FrontendApplication::gotoMain_1ScreenNoTransitionImpl);
    pendingScreenTransitionCallback = &transitionCallback;
}

void FrontendApplicationBase::gotoMain_1ScreenNoTransitionImpl()
{
    touchgfx::makeTransition<Main_1View, Main_1Presenter, touchgfx::NoTransition, Model >(&currentScreen, &currentPresenter, frontendHeap, &currentTransition, &model);
}
